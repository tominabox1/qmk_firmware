...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    KC_GESC,   KC_F1,   KC_F2, KC_F3,   KC_F4,   KC_6,   KC_VOLD,   KC_VOLU,   KC_MPLY,   MUTE,
  //,-----------------------------------------------------------------------------------------------------------.
  ...
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------|
    ...
    KC_LALT, KC_ENT, KC_NUM_SPC,KC_NUM_SPC, KC_NAV_ENT
  ),

  [_NUM_SYM] = LAYOUT(
    KC_F1,   KC_F2, KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MPRV,   KC_MNXT,   KC_MPLY,   KC_F10,
  ...
  [_NAV] = LAYOUT(
    ...
    KC_TRNS,  RGB_HUD,  RGB_SAD,  RGB_VAD,  AESTHETIC,  KC_MINS,    KC_RO,  KC_COMM,   KC_DOT,  KC_BSLS,
    TG(_GAME),  KC_TRNS,   KC_TRNS,KC_TRNS,  KC_TRNS
  ),

  [_GAME] = LAYOUT(
  KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_L, KC_U, KC_Y, TO(_BASE),
  KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_N, KC_E, KC_I, KC_O,
  KC_LCTRL, KC_A, KC_S, KC_T, KC_F, KC_G, KC_M, KC_COMM, KC_DOT, KC_SLSH,
