...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_qaz_wrap(
    ...
    KC_NAV_ENT, KC_NO, KC_NO, KC_NAV_ENT, KC_NUM_SPC, KC_NAV_ENT,KC_MPLY,KC_SLSH
  ),
  ...
  [_NAV] = LAYOUT_qaz_wrap(
    ...
    KC_TRNS,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,    KC_F7,  KC_F8,   KC_F9,
    RGB_TOG, RGB_MOD,KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,KC_TRNS,KC_BSLASH
  ),
