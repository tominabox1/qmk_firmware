...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
   ...
   LGUI_T(KC_A), LALT_T(KC_R), LCTL_T(KC_S), LSFT_T(KC_T), TD(TD_DCAP), KC_H, RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O),
    LT(_NAV, KC_Z), KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH,
                         KC_MPLY, KC_NAV_ENT,            KC_NUM_SPC, KC_MNXT
  ),
  ...
  [_NUM_SYM] = LAYOUT(
    ...
    DM_REC1,KC_LCBR,  KC_LBRC,  KC_LPRN,   KC_UNDS,            KC_RPRN,  KC_RBRC,  KC_RCBR,   KC_DOT,   KC_GRV,
                                LWIN(LCTL(KC_LEFT)),   KC_MNXT,            KC_TRNS,  LWIN(LCTL(KC_RIGHT))
  ),
  ...
  [_NAV] = LAYOUT(
    ...
    RGB_MOD,  RGB_HUD,  RGB_SAD,  RGB_VAD,  KC_NO,           KC_MINS,    KC_R,  KC_COMM,   KC_DOT,  KC_BSLS,
                                  LWIN(LCTL(KC_LEFT)),KC_MS_BTN1,           LWIN(LCTL(KC_LEFT)), LWIN(LCTL(KC_RIGHT))
  ),
};
