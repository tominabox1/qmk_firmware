...
KC_MPLY, KC_NAV_ENT,LCTL(KC_F12), KC_NUM_SPC, KC_MNXT,KC_SLSH
  ),
  ...
  [_NUM_SYM] = LAYOUT_split_3x5_3(
    ...
    KC_TRNS,  KC_LCBR,  KC_LBRC,  KC_LPRN,   KC_UNDS, KC_RPRN,  KC_RBRC,  KC_RCBR,  KC_DOT,  KC_SLSH,
        KC_TRNS,LWIN(LCTL(KC_LEFT)),  KC_TRNS,   KC_TRNS,  LWIN(LCTL(KC_RIGHT)),KC_TRNS
  ),
  ...
  [_NAV] = LAYOUT_split_3x5_3(
    ...
    RGB_MOD,  DM_REC1,  KC_NO,  KC_NO,  LCTL(KC_F12),  KC_NO,    KC_NO,  KC_COMM,   KC_DOT,  KC_BSLS,
        RGB_MOD,LWIN(LCTL(KC_LEFT)),KC_TRNS,  KC_TRNS,   LWIN(LCTL(KC_RIGHT)),  KC_MPRV
  )
};
