...
KC_MPLY, KC_NAV_ENT,KC_NAV_ENT, KC_NUM_SPC,KC_NUM_SPC,KC_MNXT
  ),
  ...
  [_NUM_SYM] = LAYOUT_split_3x5_3(
    ...
    KC_TRNS,  KC_LCBR,  KC_LBRC,  KC_LPRN,   KC_UNDS, KC_RPRN,  KC_RBRC,  KC_RCBR,  KC_DOT,  KC_SLSH,
        KC_TRNS,KC_TRNS,  KC_TRNS,   LWIN(LCTL(KC_LEFT)) ,KC_TRNS, LWIN(LCTL(KC_RIGHT))
  ),
  ...
  [_NAV] = LAYOUT_split_3x5_3(
    ...
    RGB_MOD,  DM_REC1,  KC_NO,  KC_NO, KC_NO, LCTL(KC_F12),      KC_NO,  KC_COMM,   KC_DOT,  KC_BSLS,
       KC_TRNS,KC_TRNS,  KC_TRNS,   LWIN(LCTL(KC_LEFT)) ,KC_TRNS, LWIN(LCTL(KC_RIGHT))
  )
};
