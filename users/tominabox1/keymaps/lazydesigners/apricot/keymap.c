...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    LT(_NAV,KC_Z), KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_NO,
  ...
  [_NUM_SYM] = LAYOUT(
    ...
    RGB_SAI, RGB_HUI, RGB_VAI,  KC_UNDS,  KC_UNDS,  KC_RPRN,  KC_RBRC,  KC_COMM, KC_DOT,KC_NO,
  ...
  [_NAV] = LAYOUT(
    ...
    KC_TRNS,  KC_F2,  KC_F3,  KC_F4,  LCTL(KC_F12),  KC_F6,   KC_F7,   KC_F8, KC_BSLASH,KC_NO,
