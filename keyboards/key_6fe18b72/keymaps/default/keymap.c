...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_AL), KC_SPC,  KC_SPC,  KC_SPC,  MO(_AL), KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_AL] = LAYOUT(
        ...
        _______, _______, _______, _______, TG(_UL), TG(_UL), _______, _______, KC_HOME, KC_PGDN, KC_END
    ),
