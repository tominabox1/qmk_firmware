 ...
 * | HOME   | PG UP  | Z      | X      | C      | V      |   B    | N      | M      | ,      | .      |  /     |  UP    | END    |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | PG DN  |        |  FN2   |        |      SPACE      |      SPACE      |  FN    |  FIND  |  LEFT  | DOWN   | RIGHT  |
 * '-----------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_gaming] = LAYOUT_ortho_5x14(
  ...
  LSFT_T(KC_CAPS),  KC_DEL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,     KC_J,    KC_K,    KC_L,       KC_SCLN, KC_QUOT, 	RSFT_T(KC_ENT),  \
  KC_HOME,  		KC_PGUP, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,     KC_M,    KC_COMM, KC_DOT,     KC_SLSH, KC_UP,   	KC_END, \
  KC_LCTL,  		KC_PGDN, KC_LALT, TT(3),   KC_LGUI, KC_SPC,  KC_SPC,   KC_SPC,   KC_SPC,  TT(2),   LCTL(KC_F), KC_LEFT, KC_MS_BTN4, KC_RGHT  \
 ),
...
/* FUNCTION2 - layer 3 - mostly for gaming function layer
 * .-----------------------------------------------------------------------------------------------------------------------------.
 ...
 */
 ...
 [_FN2] = LAYOUT_ortho_5x14(
  ...
  _______, S(KC_1), S(KC_2), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, C(KC_1), C(KC_2), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
